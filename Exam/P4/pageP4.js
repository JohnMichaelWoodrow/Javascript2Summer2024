...
class StoreItem {
    constructor() {
        ...
        this.item_wholesale = item_wholesale;
    ...
    get sellingPrice() {
        var sellingPrice = (this.item_wholesale + this.item_markup);
...
const loadDataIntoClass = () => {
    ...
    const loadData = new StoreItem("SAMPLE", 9.99, 0.5);
...
const preDisplay = () => {
    ...
    let name = document.getElementsByClassName('name_id');
    let wholesale = document.getElementsByClassName('wholesale_id');
    let markup = document.getElementsByClassName('markup_id');
...
const displaySellingPrice = () => {
    ...
    $("#selling_id").val(`$ {storeItem.sellingPrice}.toFixed(2)`);
